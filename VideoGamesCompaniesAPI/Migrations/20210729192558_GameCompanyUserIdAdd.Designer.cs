...
namespace VideoGamesCompaniesAPI.Migrations
{
    ...
    [Migration("20210729192558_GameCompanyUserIdAdd")]
    partial class GameCompanyUserIdAdd
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("VideoGamesCompaniesAPI.Entities.Role", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("VideoGamesCompaniesAPI.Entities.User", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("VideoGamesCompaniesAPI.Entities.GameCompany", b =>
                {
                    b.HasOne("VideoGamesCompaniesAPI.Entities.User", "CreatedBy")
                        .WithMany()
            ...
            modelBuilder.Entity("VideoGamesCompaniesAPI.Entities.User", b =>
                {
                    b.HasOne("VideoGamesCompaniesAPI.Entities.Role", "Role")
                        .WithMany()
